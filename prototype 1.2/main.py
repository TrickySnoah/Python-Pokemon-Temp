...
# before starting the main loop for the game running, start the listener thread for
# the title screen. This is where the game will start
with Listener(on_press=titleScreen.titleScreenMain) as titleScreenThread:
    titleScreenThread.join()
    print("left title screen.")
