...
while not quitGame:
    ...
    message = "In this world, there are plenty of things that can affect the way we live, including our diet, attitude, and actions." # msg that will be outputted
    ...
    if not dialogueThreadRunning:
        event = Event()
        dialogueThread = dialogue.Dialogue(event, message)
